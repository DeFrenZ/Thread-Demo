// `LoggingSystem` from https://github.com/apple/swift-log/blob/1.1.1/Sources/Logging/Logging.swift
// Made `LoggingSystem.factory` and `LoggingSystem.lock` `internal` from `fileprivate` due to it being moved to a separate file
// `Lock`s from https://github.com/apple/swift-log/blob/1.1.1/Sources/Logging/Locks.swift and put inside `LoggingSystem`
...
public enum LoggingSystem {
    internal static let lock = ReadWriteLock()
    internal static var factory: (String) -> LogHandler = StreamLogHandler.standardOutput
...
extension LoggingSystem.ReadWriteLock {
